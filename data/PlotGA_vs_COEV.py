...
if __name__=="__main__":
    ...
    DATA_FILES = ["./data/GA-RND_10x1_vs_COEV_100x100.txt","./data/GA-RND_5x2_vs_COEV_100x100.txt",
                  "./data/GA-RND_2x5_vs_COEV_100x100.txt", "./data/GA-RND_1x10_vs_COEV_100x100.txt"]
    output_file = './plots/GA-RND_XXxXX_vs_COEV_100x100'
    ...
    DATA_FILES = ["./data/GA-RND_1x5_vs_COEV_100x100.txt","./data/GA-RND_1x10_vs_COEV_100x100.txt",
            "./data/GA-RND_1x25_vs_COEV_100x100.txt", "./data/GA-RND_1x50_vs_COEV_100x100.txt"]
    output_file = './plots/GA-RND_1xXX_vs_COEV_100x100' 
    labels = []
    for d in DATA_FILES:                                                        
        labels.append(d[7:-4])
